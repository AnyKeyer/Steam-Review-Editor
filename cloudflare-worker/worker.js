...
const ANALYSIS_PROMPT = `Ты — эксперт по проверке текстов на русском языке. Проанализируй следующий текст обзора Steam-игры и найди:
...
Если есть ошибки, выведи их в формате:
• [тип ошибки]: "неправильно" → "правильно" — краткое пояснение

Будь кратким и конструктивным. Отвечай только на русском языке.
